...
abstract class $BaseResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String result, String? message, T? data});
}
...
class _$BaseResponseImpl<T> implements _BaseResponse<T> {
  const _$BaseResponseImpl({required this.result, this.message, this.data});
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>(result: $result, message: $message, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, result, message, const DeepCollectionEquality().hash(data));
